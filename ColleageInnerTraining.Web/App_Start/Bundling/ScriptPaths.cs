...
namespace ColleageInnerTraining.Web.Bundling
{
    public static class ScriptPaths
    {
        ...
        public const string Guriddo_i18n = "~/libs/guriddo_jqgrid_js/js/i18n/grid.locale-cn.js";

        public const string Guriddo_js = "~/libs/guriddo_jqgrid_js/js/jquery.jqGrid.min.js";
